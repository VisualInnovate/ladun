<template>
    <div>
        <nav
            class="z-50 flex items-center justify-between top-0 h-32 w-full container mx-auto"
            aria-label="Global"
        >
            ...
            <div
                class="hidden lg:flex lg:gap-x-7 ltr:right-0 rtl:left-0 ltr:mr-5 rtl:ml-5"
            >
                <template v-for="item in navigation" :key="item.name">
                    ...
                    >
                        ...
                        <list-group class="border-none">
                            ...
                            >
                                <list-group-item>
                                    <router-link :to="dropdownItem.href">
                                        {{ $t(dropdownItem.name) }}
                                    </router-link>
                                </list-group-item>
                            </template>
