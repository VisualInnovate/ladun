        ...
        <div class=" px-[5%] mx-auto ">
            <div class="grid lg:grid-cols-4 gap-3 w-full " >
                <div  v-for=" company in companies" :key="company.id"
                     ...
                     class="relative rounded-2xl border border-light-brown overflow-hidden  border-gray-border-light  content-center p-2  pt-5 items-center bg-[#fbfbfb] mb-12 w-[100%]   mx-auto">
