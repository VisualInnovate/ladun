        ...
        <div class=" px-[5%] mx-auto ">
            <div class="grid lg:grid-cols-4 gap-3 w-full " >
                <div  v-for=" company in companies" :key="company.id"
                     ...
                     class="relative rounded-2xl border overflow-hidden   content-center p-2 pb-8  pt-5 items-center bg-[#fbfbfb] mb-12 w-[100%]   mx-auto">
                    <div class="w-full md:w-[70%]  m-auto">

                        <img style="transform: scale(1.1);" class="img-companies h-full p-2 rounded-full border-2 mb-4 m-auto"  :src="company.media[0]?.original_url"
