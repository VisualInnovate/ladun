                    ...
                    <div class="company-button ">
                        <div class="flex flex-wrap justify-between" v-if="project.downloads">
                            <div class="w-1/2 mb-5" v-for="file in project.downloads">
                                <a :href="`/storage/${file.project_attachment}`" target="_blank"
                    ...
                    <div class="bg-black rounded-lg mb-14">
                        ...
                        <form class="grid gap-y-10 mx-5" action="https://test.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="POST">
                            <div class="flex justify-center gap-x-5">
                                <input type=hidden name="oid" value="a013G000001hMGOQA2">
                                <input type=hidden name="retURL" value="http://google.com">
                                <input  id="00N3G00000FV0J9" maxlength="255" name="00N3G00000FV0J9" size="20" type="hidden"  />  <!-- Object Of Interest --><!-- This field should not appear to the user and shall be filled automatically -->
                                <!-- choose your inquiry -->
                                <input
                                    type="text"
