                    ...
                    <tab v-for="region in department.regions" :name="region.title['en']"
                        ...
                        <div class="grid grid-cols-1 gap-10 md:grid-cols-3  pt-2 container mx-auto  [&>div]:lg:h-[574px]  [&>div]:md:h-[635px] [&>div]:h-[560px]">
                            <div  v-for="project in region.projects"
                                 class="  dark:bg-gray-800 rounded-xl  bg-[#FFF8F8]  mx-2 "
                                ...
                                <div class="flex">
                                    <router-link :to="{name: 'Project', params: { id: project.id }}">
                                        <h3 class="flex-initial dark:text-gray-300 my-auto text-[#636463] p-2 font-bold">{{ project.title[$i18n.locale] }}</h3>
                                    </router-link>
                                ...
                                <div class=" mb-4 ">
                                    <p class="px-2 h-24 text-grey text-sm col-start-1 col-end-4 dark:text-gray-400"
                                ...
                                <div class="flex justify-between py-4 ltr:text-start rtl:text-end w-full">
                                    ...
                                    <div class="flex my-auto mx-1 items-center">
                                        ...
                                        <div class="flex items-center">
                                            <small class="whitespace-nowrap text-gray-800 px-2 dark:text-gray-400">
                                                {{ project.land_area }}
                                            </small>
                                    ...
                                    <div class="flex my-auto mx-1 items-center">
                                        ...
                                        <div class="flex items-center">
                                            <small class="whitespace-nowrap text-gray-800 px-2 dark:text-gray-400">{{ project.units_number }}</small>
                                        </div>
                                    </div>
                                </div>
