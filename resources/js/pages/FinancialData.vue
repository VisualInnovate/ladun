<template>
    ...
    <section class="media-center py-28 bg-background-section pt-32">
        <div class="container mx-auto">
            ...
            <div class="flex flex-wrap " v-for="financial in financialAndReports">
    ...
    methods: {
        getAllFincials() {
            axios.get("/api/financials").then(res => {
                ...
                const reverseBaseonValues = Object.values(res.data.financialsAndYear).reverse();
                var reverseBaseonKeys = Object.keys(res.data.financialsAndYear).reverse();
                ...
                reverseBaseonValues.forEach((elem) => {
                        ...
                        this.financialAndReports.push(obj);
                        i += 1
                    }
                )
                // i = 0
